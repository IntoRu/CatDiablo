...
else
{
	...
	with (oLightParent)
	
		{
			...
			case oSweet:
			   if global.lightNight > startLight draw_sprite_ext(sLight, 0, x - _cx, y - _cy -10, (0.5 + random(0.05))*lightScale, (0.5 + random(0.05))*lightScale, 0, c_white, lightPowerfull);
			    break;
			...
			case oPlayer:
			    if global.lightNight > startLight draw_sprite_ext(sLight, 0, x - _cx, y - _sh - _cy, (0.5 + random(0.01))*lightScale, (0.5 + random(0.01))*lightScale, 0, c_white, lightPowerfull);            
			    break;
}
	    }
