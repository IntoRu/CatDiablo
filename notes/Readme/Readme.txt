РЕАЛИЗОВАН РАЗНЫЙ РАСХОД МАННЫ ДЛЯ РАЗНЫХ РУН
плюс к этому руны становятся прозрачными если их нельзя использовать
(реализована в oUI)
добавоен параметр скорости востановлении магии(его в последствии можно будет улучшать)
----------------------------------------------------
МАГИЧЕСКАЯ АТТАКА
