...
function PlayerCollision(){
	...
	var _entityList = ds_list_create() //  список сущностей с которыми мы вступаем в коллизию
	...
	// горизонтальная коллизия с сущностями
	...
	// вертикальная коллизия с сущностями
